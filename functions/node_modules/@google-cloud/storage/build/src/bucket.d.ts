...
declare class Bucket extends ServiceObject {
     ...
     */
    enableRequesterPays(callback?: any): void;
    /**
     ...
     */
    getFiles(query: GetFilesRequest, callback?: any): void;
    /**
     ...
     * });
     */
    getLabels(options: any, callback?: any): void;
    /**
     ...
     */
    request(reqOpts: any): Promise<request.Response>;
     ...
     * });
     */
    setLabels(labels: any, options: any, callback?: any): void;
    /**
     ...
     */
    makeAllFilesPublicPrivate_(options: any, callback: any): void;
    getId(): string;
}
/**
