...
declare class File extends ServiceObject {
     ...
     * Example of downloading an encrypted file:
     */
    setEncryptionKey(encryptionKey: any): this;
    /**
     ...
     * });
     */
    getSignedPolicy(options: any, callback: any): void;
    /**
     ...
     * Another example:
     */
    getSignedUrl(config: any, callback: any): void;
    /**
     ...
     */
    request(reqOpts: any): Promise<r.Response>;
     ...
     * @private
     */
    startResumableUpload_(dup: any, options: any): void;
    /**
     ...
     * @private
     */
    startSimpleUpload_(dup: any, options: any): void;
}
/**
